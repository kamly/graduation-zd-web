...
<div class="container">
    ...
    <form class="form-signin" method="POST" action="/forget/change">
        {{csrf_field()}}
        ...
        <div style="margin: 10px auto;">
            ...
            <input type="password" name="password_confirmation" id="inputEmail" class="form-control" placeholder="填写重复密码" required>
        </div>
